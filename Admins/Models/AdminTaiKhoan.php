...
class AdminTaiKhoan
{
    ...
    public function getAllTaiKhoan($chuc_vu_id, $limit = null)
    {
        try {
            $sql = "SELECT * FROM tai_khoans WHERE chuc_vu_id = :chuc_vu_id ORDER BY id ";
            if (isset($limit)) {
            ...
            return $stmt->fetchAll(); // Trả về tất cả các dòng
        } catch (Exception $e) {
